...
#include <jni.h>
/* Header for class com_revrobotics_jni_CANSparkMaxJNI */

#ifndef _Included_com_revrobotics_jni_CANSparkMaxJNI
#define _Included_com_revrobotics_jni_CANSparkMaxJNI
#ifdef __cplusplus
extern "C" {
#endif
/*
...
JNIEXPORT jint JNICALL Java_com_revrobotics_jni_CANSparkMaxJNI_c_1SparkMax_1SetpointCommand
  (JNIEnv *, jclass, jlong, jfloat, jint, jint, jfloat, jint);
