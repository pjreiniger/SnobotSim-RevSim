...
public abstract class BaseRevDeviceManager
{
    ...
    private final RevCallback mRevCallback = new RevCallback()
    {
        ...
        public void callback(String aName, int aDeviceId, ByteBuffer aBuffer, int aCount)
        {
            ...
            //
            // sLOGGER.log(Level.TRACE, "Getting send: Message ID: 0x" +
            // Integer.toHexString(aMessageId) + " -> Device ID: " + deviceId +
            // ", API Id: "
            // + apiId + ", Manufacturer: " + manufacturer + ", Device Type: " +
            // deviceType);
            //
    ...
    public BaseRevDeviceManager()
    {
        ...
        // mArbIdLookup.put(847,
        // "getParamterCore(kSmartMotionAllowedClosedLoopError_0)");
        // mArbIdLookup.put(848,
        // "getParamterCore(kSmartMotionAccelStrategy_0)");
        ...
        // mArbIdLookup.put(852,
        // "getParamterCore(kSmartMotionAllowedClosedLoopError_1)");
        // mArbIdLookup.put(853,
        // "getParamterCore(kSmartMotionAccelStrategy_1)");
        ...
        // mArbIdLookup.put(857,
        // "getParamterCore(kSmartMotionAllowedClosedLoopError_2)");
        // mArbIdLookup.put(858,
        // "getParamterCore(kSmartMotionAccelStrategy_2)");
        ...
        // mArbIdLookup.put(862,
        // "getParamterCore(kSmartMotionAllowedClosedLoopError_3)");
        // mArbIdLookup.put(863,
        // "getParamterCore(kSmartMotionAccelStrategy_3)");
